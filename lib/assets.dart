...
const String poppinBold = "assets/Poppins-SemiBold.ttf";
const String poppinNormal = "assets/Poppins-Regular.ttf";

const String influence = "assets/influence.png";
const String information = "assets/information.png";
const String post_save_earn = "assets/post_save_earn.png";
const String discover = "assets/discover.png";
const String mesh = "assets/mesh.png";
const String coins = "assets/coins.png";
const String verified_persons = "assets/verified_persons.jpg";
const String coupon = "assets/coupon.png";
const String facebook = "assets/facebook.png";
const String instagram = "assets/instagram.png";
const String logo = "assets/logo.png";
const String logo_blue = "assets/logo_blue.png";
const String logo_3 = "assets/logo_3.png";
const String pay = "assets/pay.png";
const String selfie = "assets/selfie.png";
const String shutterstock = "assets/shutterstock.png";
const String splash = "assets/splash.png";
const String tickets = "assets/tickets.png";
const String twitter = "assets/twitter.png";
const String youtube = "assets/youtube.png";
const String splash1 = "assets/splash1.jpg";
const String money_bag = "assets/money_bag.png";
const String app_icon = "assets/app_icon.png";
const String mail = "assets/mail.png";
const String Backdrop = "assets/backdrop.png";
const String logo_bg = "assets/logo_bg.png";
const String visa_master_card = "assets/visa_master_card.png";
const String app_launcher = "assets/ic_launcher.png";
const String klipp_splash = "assets/klipp_splash.png";

//const String a0 = "assets/ava0.png";
const String a1 = "assets/a1.png";
const String a2 = "assets/a2.png";
const String a3 = "assets/a3.png";
const String a4 = "assets/a4.png";
const String avatarPath = "assets/ava";

List avatars = List.generate(9, (i) {
  return "$avatarPath$i.png";
}).toList();

const String AMOUNT_EARNED = "amountEarned";
const String GENERAL_PASSWORD = "password@Klippit";
const String IS_PRE_LAUNCH = "isPreLaunch";
const String REFERRALS = "referrals";
const String INVITED_BY = "invitedBy";
const String SHOW_INVITED = "showInvited";
const String AVATAR_POSITION = "avatarPosition";
const String USE_AVATAR = "useAvatar";
const String REWARD_CODE = "rewardCode";
const String IS_REFERRED = "isReferred";
const String IS_DUMMY = "isDummy";
const String DISABLE_DUMMY = "disableDummy";
const String DISABLED = "disabled";

const String PACKAGE_FEE = "packageFee";
const String PACKAGE_TITLE = "packageTitle";
const String PACKAGE_DESC = "packageDesc";
//const String IS_ADMIN = "isAdmin";

const Color bgColor = Color(0xFF52C6D5);
const Color bgColor1 = Color(0xFFEBEDF4);
const Color txColor = Color(0xFF4E4E4E);
const Color textColor = Color(0xFF657292);
const Color textColor1 = Color(0xFF4a8fe7);
const Color textColor2 = Color(0xFF87879d);
const Color btnColor = Color(0xFF009ddc);
const Color indicatorColor = Color(0xFF58e0c2);
...
const String GOTHIC = "assets/fonts/GOTHIC.TTF";
const String OpenSansBold = "assets/fonts/OpenSans-Bold.ttf";
const String OpenSansLight = "assets/fonts/OpenSans-Light.ttf";
const String OpenSansRegular = "assets/fonts/OpenSans-Regular.ttf";
...
const String chatBackground = "assets/images/chat_bg.png";
...
const String business = "assets/images/business.png";
...
const String MINISTRY_TYPE = "ministryTpe";
...
const String CONTACT_NAME = "contactName";
...
const String IS_ONLINE_BOOL = "isOnlineBool";
...
const String WALL_POSTING = "wallPosting";
const String SUSPEND_GROUP = "suspendGroup";
...
List trophies = List.generate(21, (i) {
  return "assets/trophy/t$i${i == 12 ? ".jpg" : ".png"}";
}).toList();
